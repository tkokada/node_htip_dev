...
var MacList = function(raw_packet, offset) {
  ...
  for (var i = 0; i < this.macaddr_num; i++) {
    ...
    // var macaddr = new EthernetAddr(raw_packet, offset + 2 + this.macaddr_len * i);
...
var HtipTlv = function(raw_packet, offset, len) {
  ...
  // console.log("HTIP TTCOUI: " + this.ttc_oui + ", subtype: " + this.ttc_subtype);
  this.payload = null;
  ...
  case 0x03: // MAC address list
      ...
      // console.log("MAC address list");
      break;
  default:
      // console.log("node_pcap: HTIP() - Don't know how to decode TTC subtype " + this.ttc_subtype);
  }
};
